...
def plot_categories_bars(
    ...
    for col in plot_columns:
        ...
        # Ici, "Count" est la troisième colonne issue de .size()
        df_g.columns = [col, categorical_column, "Count"]
    
        # Calcul du pourcentage par groupe
        df_g["percentage"] = df_g["Count"] / df_g.groupby(col)["Count"].transform("sum") * 100
